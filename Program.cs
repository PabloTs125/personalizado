...
public class pez{
    ...
    public void Consultarcolor1(){
     ...
     this.cilindraje=cilindraje;}
      public void setcilindraje1 (int cilindraje1){
     this.cilindraje=cilindraje1;}
    //en esta linea encontramos la configuracion del cilindraje
    public void tostring (){
    Console.WriteLine("El auto"+modelo,"de color "+color1,"de cilindraje "+cilindraje1,"las ventas bwm "+ventasbmw);
     Console.WriteLine("El auto"+modelo1 , "de color "+color,"de cilindraje "+cilindraje,"las ventas bwm "+ventasbmw);
        }
 }
}
